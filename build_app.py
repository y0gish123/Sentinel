...
part1 = open('frontend/src/App_part1.js', 'r', encoding='utf-8').read()
part2 = open('frontend/src/App_part2.js', 'r', encoding='utf-8').read()

# remove exports from part1 and part2, and merge imports
part1_lines = part1.split('\n')
part2_lines = part2.split('\n')

# filter out imports from part2
part2_filtered = [l for l in part2_lines if not l.startswith('import')]

# remove exports
part1_filtered = [l for l in part1_lines if not l.startswith('export')]
part2_filtered = [l for l in part2_filtered if not l.startswith('export')]
              ...
              return (
                 <React.Fragment key={tab.id}>
                    <div 
                      ...
                      style={{ flex: 1, height: '100%', display: 'flex', alignItems: 'center', justifyContent: 'center', gap: '8px', background: bg, borderBottom: \`2px solid \${bColor}\`, cursor: isComplete ? 'pointer' : (isActive ? 'default' : 'not-allowed') }}>
